  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between w-full z-10">
        <Image src={isHovered ? iconHover.src : icon.src} alt={cardTitle} width={48} height={48} />
        <p className="text-xl font-sohne flex-grow text-center mx-auto">{cardTitle}</p>
        <Image src={arrow.src} alt="Arrow" layout="fixed" objectFit="fill" width={10} height={10} />
      </div>
    </div>
  );
};
